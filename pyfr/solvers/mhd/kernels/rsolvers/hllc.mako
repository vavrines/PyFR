...
<%pyfr:macro name='rsolve_t1d' params='ul, ur, nf'>
    ...
    if (sl >= 0) {
        ...
        fpdtype_t p_star = rl*(sl - nvl)*(s_star - nvl) + pl - Bl[0]*Bl[0] + B_hll[0]*B_hll[0];
        ...
        ulstar[4] = B_hll[1];
        ulstar[5] = 0.0;
        ulstar[6] = ul[6]*(sl - nvl)/(sl - s_star) + (p_star*s_star - pl*nvl - (B_hll[0]*Bdotv_hll - Bl[0]*Bdotvl))/(sl - s_star);
        % elif ndims == 3:
        ...
        ulstar[6] = B_hll[2];
        ulstar[7] = 0.0;
        ulstar[8] = ul[8]*(sl - nvl)/(sl - s_star) + (p_star*s_star - pl*nvl - (B_hll[0]*Bdotv_hll - Bl[0]*Bdotvl))/(sl - s_star);
        % endif
        ...
        fpdtype_t p_star = rr*(sr - nvr)*(s_star - nvr) + pr - Br[0]*Br[0] + B_hll[0]*B_hll[0];
        ...
        urstar[4] = B_hll[1];
        urstar[5] = 0.0;
        urstar[6] = ur[6]*(sr - nvr)/(sr - s_star) + (p_star*s_star - pr*nvr - (B_hll[0]*Bdotv_hll - Br[0]*Bdotvr))/(sr - s_star);
        % elif ndims == 3:
        ...
        urstar[6] = B_hll[2];
        urstar[7] = 0.0;
        urstar[8] = ur[8]*(sr - nvr)/(sr - s_star) + (p_star*s_star - pr*nvr - (B_hll[0]*Bdotv_hll - Br[0]*Bdotvr))/(sr - s_star);
        % endif

...
modules = [
    ...
    'pyfr.solvers.mpaceuler',
    'pyfr.solvers.mpaceuler.kernels',
    'pyfr.solvers.mpaceuler.kernels.bcs',
    'pyfr.solvers.mpaceuler.kernels.rsolvers',
...
package_data = {
    ...
    'pyfr.solvers.mpaceuler.kernels': ['*.mako'],
    'pyfr.solvers.mpaceuler.kernels.bcs': ['*.mako'],
    'pyfr.solvers.mpaceuler.kernels.rsolvers': ['*.mako'],
